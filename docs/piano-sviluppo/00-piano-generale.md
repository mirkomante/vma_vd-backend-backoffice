...
|---|---|---|---|
| Fase 1 | Setup progetto: Next.js, PayloadCMS, Tailwind, database locale, dipendenze base | 🔶 in corso (1.1 ✅) | `fase-1-setup.md` (+ file di variante database) |
...
- **Prossimo passo**: Fase 1, sottofase 1.2 — vedi `fase-1-setup.md`.
