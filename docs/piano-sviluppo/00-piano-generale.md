...
|---|---|---|---|
| Fase 1 | Setup progetto: Next.js, PayloadCMS, Tailwind, database locale, dipendenze base | 🔶 in corso (1.1 ✅, 1.2 ✅, 1.3 ✅, 1.4 ✅, 1.5 ✅) | `fase-1-setup.md` (+ file di variante database) |
...
- **Prossimo passo**: Fase 1, sottofase 1.6 — vedi `fase-1-setup.md`.
